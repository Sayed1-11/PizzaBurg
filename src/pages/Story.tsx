  ...
  return (
    <div ref={containerRef} className="bg-background text-white selection:bg-primary selection:text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <span className="text-secondary font-bold tracking-[0.5em] uppercase mb-6 block text-sm md:text-base animate-pulse">
            Establishing the Legacy
          </span>
          <h1 className="text-7xl md:text-[12vw] font-display leading-[0.8] mb-8">
            BEYOND<br />
            <span className="text-primary italic">CRUST</span>
          </h1>
          <p className="max-w-2xl mx-auto text-lg md:text-2xl text-white/60 font-medium">
            A journey from a singular kitchen vision to the digital frontier of Bangladeshi flavor.
          </p>
        </motion.div>
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full opacity-20 pointer-events-none">
             {/* Imagine a high-tech glowing grid and floating particles here */}
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div className="relative group overflow-hidden rounded-3xl aspect-video border border-white/10">
              {/* Futuristic Video/Image Placeholder */}
              <div className="absolute inset-0 bg-black flex items-center justify-center">
                <span className="text-primary font-bold tracking-widest animate-pulse">FUTURE_KITCHEN_POV.MP4</span>
              </div>
              <img 
                src="https://images.unsplash.com/photo-1590947132387-155cc02f3212?q=80&w=2070" 
                alt="Cyberpunk pizza preparation with neon accents" 
